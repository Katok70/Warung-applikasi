...
<div class="shell">
  ...
  <div id="header">
    ...
    <!-- Cart -->
    <!-- <div id="cart"> <a href="#" class="cart-link">Keranjang Belanja Anda</a>
      <div class="cl">&nbsp;</div>
      <span>Jumlah: <strong>4</strong></span> &nbsp;&nbsp; <span>Total: <strong>Rp 250.000</strong></span> </div>
    <!-- End Cart --> 
    <!-- Navigation -->
    <div id="navigation">
      <ul>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div id="slider" class="box">
        <div id="slider-holder">
          <ul>
            ...
            <li><a href="#"><img src="<c:url value="/resources/css/images/slide1.jpg" />" alt="" /></a></li>
            <li><a href="#"><img src="<c:url value="/resources/css/images/slide3.png" />" alt="" /></a></li>
          </ul>
        </div>
      ...
      <div class="products">
        <div class="cl">&nbsp;</div>
        <ul>
          <li> <a href="#"><img src="<c:url value="/resources/css/images/big1.jpg" />" alt="" /></a>
          ...
          <li> <a href="#"><img src="<c:url value="/resources/css/images/big1.jpg" />" alt="" /></a>
            <div class="product-info">
              ...
              <div class="product-desc">
                <h4>LAINNYA</h4>
                <p>Aplikasi penghitungan<br />
                  amet</p>
                <strong class="price">50.000</strong> </div>
            </div>
          </li>
          <li class="last"> <a href="#"><img src="<c:url value="/resources/css/images/big1.jpg" />" alt="" /></a>
            <div class="product-info">
              <h3>I Note</h3>
              <div class="product-desc">
                <h4>Lainnya</h4>
                <p>Aplikasi pencatat <br />
                  amet</p>
                <strong class="price">50.000</strong> </div>
            </div>
          </li>
